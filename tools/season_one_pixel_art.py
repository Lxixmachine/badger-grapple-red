...
PALETTE = {
    ...
    # High-key mint lawns follow the classic GBA hierarchy: chromatic but
    # spatially quiet. Saturation lives in the field hue, not in noisy detail.
    "grass": (115, 196, 161, 255),
    "grass_light": (181, 228, 205, 255),
    "grass_dark": (105, 181, 150, 255),
    "grass_shadow": (92, 145, 111, 255),
    "mowed": (154, 207, 178, 255),
    "mowed_light": (171, 218, 193, 255),
    # Shared dirt remains the architectural/prop ramp used by gold shadows.
    # Walking surfaces have a separate role so a path retune cannot repaint
    # building trim, trophies, shop fixtures, or other identity objects.
    "dirt": (213, 187, 127, 255),
    "dirt_light": (235, 211, 155, 255),
    "dirt_dark": (169, 133, 84, 255),
    "path_dirt": (226, 208, 163, 255),
    "path_dirt_light": (241, 226, 190, 255),
    "path_dirt_dark": (183, 151, 104, 255),
    "brick": (176, 70, 61, 255),
    ...
    "concrete": (218, 223, 220, 255),
    "concrete_light": (237, 240, 237, 255),
    "concrete_dark": (186, 194, 191, 255),
    ...
    "shop_floor": (151, 183, 186, 255),
    "shop_floor_light": (180, 204, 201, 255),
    "shop_floor_dark": (111, 145, 155, 255),
...
EDGE_STYLES = {
    ...
    "surface_stone": EdgeStyle("grass", "stone", (3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 3, 4, 4, 3, 3, 3), None, PALETTE["path_stone"]),
    ...
    "surface_concrete": EdgeStyle("grass", "concrete", (3,) * 16, PALETTE["concrete"], None),
