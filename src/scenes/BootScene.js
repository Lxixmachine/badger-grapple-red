  ...
  create(){
    ...
    if(params.has('test')&&params.get('scene')==='battle'){
      ...
      this.scene.start('BattleScene',{
        ...
        trainerName:params.get('trainerName')||undefined
      });
      return;
    }
