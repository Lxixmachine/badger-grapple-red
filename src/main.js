...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.37-head-over-lintel';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
