...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.33-firered-cadence';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
