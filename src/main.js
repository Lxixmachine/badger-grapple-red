...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.32-state-street';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
