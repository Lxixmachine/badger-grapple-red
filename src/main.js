...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.22-world-composition';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
