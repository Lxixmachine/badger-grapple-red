...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.11-route-trainers';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
