...
let game;try{game=new Phaser.Game(config);window.badgerGame=game;window.BADGER_VERSION='21.53-captain-gate';}catch(e){fail(e?.stack||e?.message||String(e));throw e;}
