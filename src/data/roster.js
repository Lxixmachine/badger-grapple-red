export const ROSTER={
 ...
 captainneutral:{id:'captainneutral',name:'Captain Neutral',weight:'174',style:'Neutral',rarity:'Elite',asset:'neutral',color:0xb71b25,stats:{hp:88,atk:26,def:21,spd:20,gas:90},moves:['single','highc','reattack','flurry'],bio:'Annex Arena gym leader. First badge test.',strengths:'All positions',weaknesses:'None obvious',personality:'Captain'},
 scrambleboss:{id:'scrambleboss',name:'The Funk Doctor',weight:'157',style:'Scramble',rarity:'Elite',asset:'scramble',tint:0xffb36b,stats:{hp:100,atk:29,def:22,spd:28,gas:96},moves:['funk','scramble','cradle','reattack'],bio:'Picnic Point gym leader. Nobody solves the scramble.',strengths:'Transition wrestling',weaknesses:'None obvious',personality:'Unbothered'},
 topboss:{id:'topboss',name:'The Anchor',weight:'197',style:'Top',rarity:'Elite',asset:'top',tint:0x7fb5ff,stats:{hp:112,atk:30,def:28,spd:16,gas:98},moves:['ride','tilt','cradle','pin'],bio:'Kohl Center gym leader. Nobody escapes the ride.',strengths:'Mat control',weaknesses:'None obvious',personality:'Immovable'}
};
