...
export const TRAINERS = {
  ...
  river_tavi: { id: 'river_tavi', look: 'gray', area: 'river', name: 'Tavi', pos: { x: 33, y: 5 }, facing: 'down', sightRange: 4, team: [['funkflyer', 12], ['riverroller', 12]], reward: { grit: 14, rep: 10 }, line: 'Tavi: The Funk Doctor taught me everything. Well - almost everything.', beaten: 'Tavi: You scramble clean. The Doctor holds court by the fire circle. Good luck.', spot: 'Tavi: Heading for the Doctor? You roll through me first.' }
};
