...
export const BATTLE_CHOREOGRAPHY=Object.freeze({
  ...
  tilt:move('rolling-load','tilt-rolls',{dx:22,dy:-7,duration:240,lunge:16,lift:-5,knockback:8,targetLift:-5,shake:2,flash:58,feedback:760,hitStagger:430}),
  ...
  flurry:move('repeated-rush','flurry-streaks',{dx:45,dy:1,duration:180,lunge:29,knockback:9,shake:2,flash:55,feedback:800,hitStagger:350}),
