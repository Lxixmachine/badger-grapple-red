...
import {DEFAULT_PLAYER_SETTINGS,normalizePlayerSettings} from './playerSettings.js';
...
export function normalizeState(state){
  ...
  state.settings=normalizePlayerSettings(state.settings);
