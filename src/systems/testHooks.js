export function installTestHooks(game, routeVirtualButton) {
  ...
  const sceneState = key => {
    ...
    return {
      ...
      travelConfirm: scene.travelConfirm ?? null,
      confirmReset: scene.confirmReset ?? null,
      ...
      battleSprites: scene.enemySprite && scene.playerSprite ? {
        ...
        enemyPosition: [scene.enemySprite.x,scene.enemySprite.y],
        playerPosition: [scene.playerSprite.x,scene.playerSprite.y]
      } : null,
